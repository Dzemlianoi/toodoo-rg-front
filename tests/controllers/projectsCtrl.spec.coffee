describe 'ProjectsController', ->
  beforeEach ->
    ...
    @http.whenGET('http://localhost:3000/projects.json').respond(200, @projects)
  ...
  describe 'load', ->
    ...
    it 'adds a project', ->
      @http.whenPOST('http://localhost:3000/projects.json').respond(200, { id: 3, title:'New task'})
      @scope.addProject()
      @http.flush()
      expect(@scope.projects.length).toEqual(3)

    it 'delete a project', ->
      @http.whenDELETE('http://localhost:3000/projects/1.json').respond(200, {})
